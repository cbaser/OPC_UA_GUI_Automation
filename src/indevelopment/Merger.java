...
public class Merger {
 ...
 private  Font smallBold = new Font(Font.FontFamily.TIMES_ROMAN, 12,
	...
	public void addToDataset(DefaultCategoryDataset dataset) throws IOException {
			...
			String content=txtToString(tempFile+"_1.txt");
			Pattern titlePattern = Pattern.compile(regex);
			Matcher matcher = titlePattern.matcher(content);
			while(matcher.find()) {
				dataset.addValue(Double.valueOf(matcher.group("total")), "omega", "Total");
				dataset.addValue(Double.valueOf(matcher.group("min")), "omega", "Min");
				dataset.addValue(Double.valueOf(matcher.group("max")), "omega", "Max");
				dataset.addValue(Double.valueOf(matcher.group("avg")), "omega", "Avg");
				dataset.addValue(Double.valueOf(matcher.group("co")), "omega", "Co");
				dataset.addValue(Double.valueOf(matcher.group("std")), "omega", "Std");
			}
